...
namespace OnePEY\OnePEY\Model\Ipn;

/**
 * Base IPN Handler Class
 *
 * Class AbstractIpn
 * @package OnePEY\OnePEY\Model\Ipn
 */
abstract class AbstractIpn
{
    ...
    /**
     * @var \OnePEY\OnePEY\Model\Config
     */
     ...
     * @throws \Exception
     * @throws \OnePEY\Exceptions\InvalidArgument
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function handleOnePEYNotification()
    {
     ...
     * @throws \Magento\Framework\Exception\LocalizedException
     */
    public function handleOnePEYCustomerReturn()
    {
        $this->_configHelper->initGatewayClient();
        ...
        if (!$webhook->isValid() || empty($webhook->getUid()) || !$webhook->isAuthorized()){
        	...
        	return self::CUSTOMER_RETURN_ERROR;
        			...
        			array(\OnePEY\OnePEY\Helper\Data::PROC_STATUS_AUTHORIZED,
        					\OnePEY\OnePEY\Helper\Data::PROC_STATUS_APPROVED))){
