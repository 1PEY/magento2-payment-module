...
class Config implements \Magento\Payment\Model\Method\ConfigInterface
{
    ...
    {
        \OnePEY\Settings::$merchantId  = $this->getShopId();
        \OnePEY\Settings::$passCode = $this->getShopKey();
        \OnePEY\Settings::$pSignAlgorithm = \OnePEY\PSignAlgorithm::$ALGO_SHA1;
        \OnePEY\Settings::$gatewayBase = 'https://' . $this->getDomainGateway();
        \OnePEY\Settings::$checkoutBase = 'https://' . $this->getDomainCheckout();
    }
